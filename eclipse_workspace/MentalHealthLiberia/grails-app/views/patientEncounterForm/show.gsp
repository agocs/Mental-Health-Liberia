            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="patientEncounterForm.counseling.label" default="Counseling" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: patientEncounterFormInstance, field: "counseling")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="patientEncounterForm.employmentStatus.label" default="Employment Status" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: patientEncounterFormInstance, field: "employmentStatus")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="patientEncounterForm.reasonForVisit.label" default="Reason For Visit" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: patientEncounterFormInstance, field: "reasonForVisit")}</td>
