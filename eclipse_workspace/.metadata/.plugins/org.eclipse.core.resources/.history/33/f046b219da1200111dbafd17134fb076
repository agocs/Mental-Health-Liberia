                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: patientEncounterFormInstance, field: 'cage', 'errors')}">
                                    <g:textField name="cage" value="${patientEncounterFormInstance?.cage}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" cl
								  ...
								  <option value="audi">Audi</option>ass="value ${hasErrors(bean: patientEncounterFormInstance, field: 'clinicianTrainingLevel', 'errors')}">
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="counseling"><g:message code="patientEncounterForm.counseling.label" default="Counseling" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: patientEncounterFormInstance, field: 'counseling', 'errors')}">
                                    <g:textField name="counseling" value="${patientEncounterFormInstance?.counseling}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="employmentStatus"><g:message code="patientEncounterForm.employmentStatus.label" default="Employment Status" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: patientEncounterFormInstance, field: 'employmentStatus', 'errors')}">
                                    <g:textField name="employmentStatus" value="${patientEncounterFormInstance?.employmentStatus}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: patientEncounterFormInstance, field: 'gaf', 'errors')}">
                                    <g:textField name="gaf" value="${patientEncounterFormInstance?.gaf}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: patientEncounterFormInstance, field: 'phq', 'errors')}">
                                    <g:textField name="phq" value="${patientEncounterFormInstance?.phq}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="reasonForVisit"><g:message code="patientEncounterForm.reasonForVisit.label" default="Reason For Visit" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: patientEncounterFormInstance, field: 'reasonForVisit', 'errors')}">
                                    <g:textField name="reasonForVisit" value="${patientEncounterFormInstance?.reasonForVisit}" />
                                </td>
                            </tr>
