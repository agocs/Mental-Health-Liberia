...
public class MentalHealthLiberiaView extends FrameView {
    ...
    private void initComponents() {
        ...
        clinicianTrainingLevel.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "No formal training", "Community health worker training", "Physician's assistant training", "General nursing training", "Psychiatric nurse training", "Other" };
        ...
        referralSource.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Clinician", "Messages (radio, etc)", "Other" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
        ...
        employmentStatus.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Not working", "Working" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
        ...
        maritalStatus.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Single, never married", "Married", "Divorsed", "Widowed" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
        ...
        education.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "No formal education", "Grade (primary) school", "High school", "Some university", "University" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
        ...
        individualCounseling.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "CBT", "DBT", "Motivational interviewing" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
        ...
        familyPsychoEducation.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Support group", "Other" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
        ...
        dischargeDisposition.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Home", "Hospital", "Psychiatric facility", "Prison", "Other" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
...
private void saveMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveMenuItemActionPerformed
    ...
    if (directory.isDirectory()) {
        ...
        try {
            ...
            String data = serializer.serialize(formData);
            writer.write(data);
            writer.close();
